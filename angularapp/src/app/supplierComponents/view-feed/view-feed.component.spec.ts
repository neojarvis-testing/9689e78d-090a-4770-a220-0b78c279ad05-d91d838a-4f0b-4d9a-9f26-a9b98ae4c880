...
describe('ViewFeedComponent', () => {
  ...
  fit('Frontend_should_create_view_feed_component', () => {
    const app = fixture.componentInstance;
    expect(app).toBeTruthy();
  });

  fit('Frontend_should_check_if_the_heading_feeds_exists_in_view_feed_component', () => {
    const compiled = fixture.nativeElement;
    expect(compiled.querySelector('h1').textContent).toContain('Feeds');
  });


  fit('Frontend_should_check_if_the_table_exists_in_view_feed_component', () => {
