...
const routes: Routes = [
  ...
  {path:'owner/navbar',component:OwnerNavbarComponent,canActivate: [Authguard1Guard]},
  {path:'owner/livestock-form',component:LivestockFormComponent,canActivate: [Authguard1Guard]},
  {path:'owner/livestock-form/:id',component:LivestockFormComponent,canActivate: [Authguard1Guard]},
  {path:'owner/my-request',component:MyRequestComponent,canActivate: [Authguard1Guard]},
  {path:'owner/view-feed',component:OwnerViewfeedComponent,canActivate: [Authguard1Guard]},
  {path:'owner/view-livestock',component:ViewLivestockComponent,canActivate: [Authguard1Guard]},
];
